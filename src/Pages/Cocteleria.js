        ...
        <div className="d-flex justify-content-between py-5">
          <div className="mx-auto">
            ...
            <p style={{ maxWidth: "600px" }}>
              ...
              más emblemáticos y amados de nuestro país. En especial en los días
              calurosos de verano, este coctel ligero, fácil de hacer y de
              beber, es delicioso con un sabor fresco y muy bueno.
            </p>
        ...
        <div className="d-flex justify-content-between py-5">
          ...
          <div className="mx-auto">
            ...
            <p style={{ maxWidth: "600px" }}>
              ...
              pedir en las cantinas lo que se convertiría en su mezcla favorita:
              pisco y vermouth. Este refrescante cóctel es excelente si buscas
