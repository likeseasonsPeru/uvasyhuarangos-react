  ...
  return (
    <div className="pb-40 pt-20" style={{ paddingTop: "20px" }}>
      <div className="row p-0 p-lg-5 p-md-5 justify-content-around">
        <div className="col-md-2 d-flex flex-row justify-content-between align-items-center">
          <div>
            <Link
            ...
            <p className="logo-footer text-center mt-3">
              <Link
                to="#"
                onClick={() => {
        ...
        <div className="col-md-6">
          <div className="row">
            <div className="col-md-7 d-flex flex-column justify-content-between">
              <h4
                className="subtitle-footer text-center"
                style={{ color: color }}
              >
            ...
            <div className="col-md-5">
              <h4
                className="subtitle-footer text-center my-3"
                style={{ color: color }}
              >
                DI HOLA!
              </h4>
